  ...
  for (CXXRecordDecl::capture_const_iterator I = CXXDecl->captures_begin(),
    ...
    if (C.capturesVariable()) {
      ...
      llvm::DIType *fieldType = createFieldType(
          ...
          layout.getFieldOffset(fieldno), VUnit, IsZeroSize, RecordTy, CXXDecl);
...
void CGDebugInfo::CollectRecordNormalField(
  ...
  if (field->isBitField()) {
    ...
    FieldType = createFieldType(name, type, field->getLocation(),
                                ...
                                RecordTy, IsZeroSize, RD, Annotations);
  }
...
void CGDebugInfo::collectDefaultFieldsForBlockLiteralDeclare(
  ...
  if (CGM.getLangOpts().OpenCL) {
    ...
    Fields.push_back(createFieldType(
        ...
        BlockLayout.getElementOffsetInBits(2), Unit, IsZeroSize, Unit));
    ...
    Fields.push_back(createFieldType(
        ...
        Loc, AS_public, BlockLayout.getElementOffsetInBits(4), Unit, IsZeroSize,
        Unit));
  }
}
  ...
  for (const BlockLayoutChunk &Chunk : chunks) {
    ...
    if (!capture) {
      ...
      fields.push_back(createFieldType("this", type, loc, AS_public,
                                       offsetInBits, tunit, IsZeroSize, tunit));
      continue;
    }
