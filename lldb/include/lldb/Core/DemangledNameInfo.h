...
struct DemangledNameInfo {
  ...
  ///                      start    end
  /// \endcode
  std::optional<std::pair<size_t, size_t>> BasenameRange;
  ...
  ///       start           end
  /// \endcode
  std::optional<std::pair<size_t, size_t>> ScopeRange;
  ...
  ///                      start           end
  /// \endcode
  std::optional<std::pair<size_t, size_t>> ArgumentsRange;
  ...
  ///                                     start     end
  /// \endcode
  std::optional<std::pair<size_t, size_t>> QualifiersRange;

  /// Returns \c true if this object holds a valid basename range.
  bool hasBasename() const {
    return BasenameRange && BasenameRange->second > BasenameRange->first;
  }
...
struct TrackingOutputBuffer : public llvm::itanium_demangle::OutputBuffer {
  ...
  void notifyDeletion(size_t Old, size_t New) override;
...
private:
  ...
  /// Helpers that initialize the otherwise optional range members of
  /// this object.
  void initBasename();
  void initScope();
  void initArguments();
