...
FileSpecList TargetProperties::GetSafeLoadPaths() const {
  ...
  {
      llvm::StringRef default_paths_str = GetPropertyAtIndexAs<llvm::StringRef>(idx, g_target_properties[idx].default_cstr_value);
  ...
  // TODO: we want to configure these strings into TableGen so they show up in 'settings show'
