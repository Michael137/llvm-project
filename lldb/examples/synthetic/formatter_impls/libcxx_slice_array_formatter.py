...
def init_formatter(debugger, dict):
    debugger.HandleCommand(f'type synthetic add -x "^std::__[[:alnum:]]+::slice_array<.+>$" -l lldb.formatters.cpp.formatter_impls.libcxx_slice_array_formatter.LibcxxStdSliceArraySyntheticFrontEnd -w "cplusplus-py"')
