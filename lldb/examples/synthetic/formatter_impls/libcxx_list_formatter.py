...
def init_formatter(debugger, dict):
    debugger.HandleCommand(f'type synthetic add -x "^std::__[[:alnum:]]+::list<.+>$" -l lldb.formatters.cpp.formatter_impls.libcxx_list_formatter.LibcxxListSyntheticFrontEnd -w "cplusplus-py"')
