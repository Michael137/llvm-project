...
void test_lookup_before_using_directive()
{
  ...
  __builtin_printf("before using directive: func() = %d\n", func()); // eval func(), exp: 1
}
using namespace A;
void test_lookup_after_using_directive()
{
  // BP_after_using_directive
  //__builtin_printf("func() = %d\n", func()); // eval func(), exp: error, ambiguous
  __builtin_printf("after using directive: func2() = %d\n", func2()); // eval func2(), exp: 3
  __builtin_printf("after using directive: ::func() = %d\n", ::func()); // eval ::func(), exp: 1
  __builtin_printf("after using directive: B::func() = %d\n", B::func()); // eval B::func(), exp: 4
}
