...
class MixedLanguagesTestCase(TestBase):
    def test_language_of_frame(self):
        ...
        format_string = "frame #${frame.index}: ${frame.pc}{ ${module.file.basename}\\`${function.name-without-args}{${function.pc-offset}}}{, lang=${language}}\n"
